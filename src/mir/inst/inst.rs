...
impl std::fmt::Debug for MirInst {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            MirInst::LoadStoreGr64(inst) => inst.fmt(f),
            MirInst::LoadStoreGr32(inst) => inst.fmt(f),
            MirInst::LoadStoreF64(inst) => inst.fmt(f),
            MirInst::LoadStoreF32(inst) => inst.fmt(f),
            MirInst::LoadStoreGr64Base(inst) => inst.fmt(f),
            MirInst::LoadStoreGr32Base(inst) => inst.fmt(f),
            MirInst::LoadStoreF64Base(inst) => inst.fmt(f),
            MirInst::LoadStoreF32Base(inst) => inst.fmt(f),
            MirInst::LoadStoreGr64Indexed(inst) => inst.fmt(f),
            MirInst::LoadStoreGr32Indexed(inst) => inst.fmt(f),
            MirInst::LoadStoreF64Indexed(inst) => inst.fmt(f),
            MirInst::LoadStoreF32Indexed(inst) => inst.fmt(f),
            MirInst::LoadStoreGr64Literal(inst) => inst.fmt(f),
            MirInst::LoadStoreGr32Literal(inst) => inst.fmt(f),
            MirInst::LoadStoreF64Literal(inst) => inst.fmt(f),
            MirInst::LoadStoreF32Literal(inst) => inst.fmt(f),
