...
impl<'a> FuncFormatContext<'a> {
    ...
    pub fn format_inst(&mut self, inst: &MirInst) -> std::fmt::Result {
        ...
        match inst {
            ...
            MirInst::BLinkGlobal(blink_global) => {
                format_inst::fmt_blink_global(self, inst.get_opcode(), blink_global)
            }
            ...
            MirInst::CSet64(c_set64) => format_inst::fmt_cset64(self, inst.get_opcode(), c_set64),
            MirInst::CSet32(c_set32) => format_inst::fmt_cset32(self, inst.get_opcode(), c_set32),
